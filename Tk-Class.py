...
class Body:
    def __init__(self):
        Body.ParamTorus(self,10,2) #bei initialisierung wird im Konstruktor der K�rper Parametrisiert
    ...
    def ParamTorus(self,Ra,Ri):
        ...
        p,t= np.mgrid[0:2*np.pi:10j, 0:2*np.pi:10j] #aufl�sung des K�rpers 
